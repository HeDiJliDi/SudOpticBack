...
public partial class ParametreDiver
{
    ...
    public string CodeArticleAvoir { get; set; } = null!;

    public int NombreValise { get; set; }

    public bool EngagementPaiementParClient { get; set; }

    public int NombreJoursBlocageClientApresDerniereDateBl { get; set; }
}
