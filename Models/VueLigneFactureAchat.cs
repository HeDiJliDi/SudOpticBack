...
public partial class VueLigneFactureAchat
{
    ...
    public string? CodeArticleFournisseur { get; set; }

    public decimal PrixAchatHtdevise { get; set; }

    public decimal PrixAchatHtchange { get; set; }
}
